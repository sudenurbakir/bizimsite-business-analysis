...
## US-24 - Rol Kapsamındaki İşlemlere Erişim
...
## US-25 - Yönetim İşlemlerinin Yetkisiz Kullanıcılardan Korunması
...
## US-26 - Özel Kullanıcı Bilgilerinin Korunması
...
|---|---|---|
| US-24 | Sistem Kullanıcısı | Rol kapsamında izin verilen işlemlere erişmek |
| US-25 | Site Yöneticisi | Yönetim işlemlerini yetkisiz erişime karşı korumak |
| US-26 | Site Sakini | Özel kullanıcı bilgilerinin gizliliğini korumak |
